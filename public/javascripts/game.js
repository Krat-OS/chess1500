...
class Chess {
	...
	async assignPlayers() {
		...
		return new Promise((resolve) => {
			const player1 = new Player({ username: "Player1", id: 1, role: "white" }); // player 1
			const player2 = new Player({ username: "Player2", id: 2, role: "black" }); // player 2
...
class Piece {
	...
	create() {
		...
		// apply
		pieceElement.src = `./images/pieces/${this.info.alias}.png`;
...
class Player {
	...
	async getPieces() {
		...
		let path = `./javascripts/json/${role}-pieces.json`; // just a path of json file
